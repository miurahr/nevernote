...
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\PDFRenderer.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\apache-mime4j-0.6.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\commons-codec-1.3.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\commons-compress-1.1.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\commons-lang-2.4.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\commons-logging-1.1.1.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\evernote.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\h2-1.2.147.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\httpclient-4.0.3.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\httpcore-4.0.1.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\httpmime-4.0.3.jar
...
set NN_CLASSPATH=%NN_CLASSPATH%;%NIXNOTE%lib\pdfbox-app-1.3.1.jar
