...
public class RNotebookTable {
	
	private final ApplicationLogger 		logger;
	RDatabaseConnection							db;
	public NotebookRequest					mainResponse;
	
	// Constructor
	public RNotebookTable(ApplicationLogger l, RDatabaseConnection d) {
		logger = l;
		db = d;
		mainResponse = new NotebookRequest();
	}
	// Create the table
